...
% \setmainfont{FreeSerif} %% задаёт основной шрифт документа
...
\hypersetup{
    ...
    pdftitle={Решение задачи поддержки очереди задач IBM LSF в клиенте запуска расчетов на кластере Scheduler}
}
...
\renewcommand{\labelenumii}{\asbuk{enumi})} % Список второго уровня
...
\titleformat{\subsection}[block]{\vspace{1em}}{}{12.5mm}{\centering{\thesubsection\quad#1\vspace{1em}}}
\titleformat{\subsubsection}[block]{\vspace{1em}\normalsize}{}{12.5mm}{\centering{\thesubsubsection\quad#1\vspace{1em}}}
