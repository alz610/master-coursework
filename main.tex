...
\includepdf{extra/title_signed} % Титульный лист

\tableofcontents % Содержание
\clearpage

\input{inc/0-intro} % Введение
\input{inc/1-LSF_overview} % Обзор LSF
% \input{inc/2-pz} % Постановка задачи
% \input{inc/3-solution} % Решение
\input{inc/3-problem} % Задача
